...
<html lang="en">
  ...
  <body style="background-color: #1f1f1f;">
    ...
    <div class="content" style="background-color: #1f1f1f; border-color: #C5FF01; border-width: 20px; margin: 80px;">
                        ...
                        <div class="card-body">
                            ...
                            <form action="homepage.php" method="post">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <a href="../User/Registrasi.php"> Belum Punya Akun? Yuk Daftar! </a>
                                </div>
